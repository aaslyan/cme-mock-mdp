...
void print_instrument_details(const InstrumentDefinition* instrument) {
    ...
    switch (instrument->product_group) {
        case ProductGroup::Equity: group_name = "Equity"; break;
        case ProductGroup::Energy: group_name = "Energy"; break;
        case ProductGroup::Metals: group_name = "Metals"; break;
        case ProductGroup::Interest: group_name = "Interest Rate"; break;
        case ProductGroup::FX: group_name = "Foreign Exchange"; break;
        case ProductGroup::Agricultural: group_name = "Agricultural"; break;
    }
    ...
    switch (instrument->trading_status) {
        case TradingStatus::Trading: status_name = "Trading"; break;
        case TradingStatus::Halted: status_name = "Halted"; break;
        case TradingStatus::PreOpen: status_name = "Pre-Open"; break;
        case TradingStatus::NoCancel: status_name = "No Cancel"; break;
...
void test_configuration_integration() {
    ...
    for (size_t i = 0; i < supported_symbols.size(); ++i) {
        ...
        if (i < supported_symbols.size() - 1) std::cout << ", ";
    }
    std::cout << std::endl;
}
