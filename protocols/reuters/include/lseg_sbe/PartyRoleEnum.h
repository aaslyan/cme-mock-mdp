...
#ifndef _LSEG_SBE_PARTYROLEENUM_CXX_H_
#define _LSEG_SBE_PARTYROLEENUM_CXX_H_
...
public:
    enum Value
    {
        TradingFirm = static_cast<std::uint8_t>(1),
    ...
    static PartyRoleEnum::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            case static_cast<std::uint8_t>(1): return TradingFirm;
    ...
    static const char *c_str(const PartyRoleEnum::Value value)
    {
        switch (value)
        {
            case TradingFirm: return "TradingFirm";
