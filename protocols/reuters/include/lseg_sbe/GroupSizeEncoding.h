...
#ifndef _LSEG_SBE_GROUPSIZEENCODING_CXX_H_
#define _LSEG_SBE_GROUPSIZEENCODING_CXX_H_
...
public:
    ...
    GroupSizeEncoding &numGroups(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_BIG_ENDIAN_ENCODE_16(value);
    ...
    GroupSizeEncoding &numVarDataFields(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_BIG_ENDIAN_ENCODE_16(value);
