...
#ifndef _LSEG_SBE_HEARTBEAT_CXX_H_
#define _LSEG_SBE_HEARTBEAT_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(504);
    ...
    Heartbeat &messageType(const MessageTypeEnum::Value value) SBE_NOEXCEPT
    {
        char val = (value);
