...
#ifndef _CME_SBE_MDINCREMENTALREFRESHTRADESUMMARYLONGQTY65_CXX_H_
#define _CME_SBE_MDINCREMENTALREFRESHTRADESUMMARYLONGQTY65_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(65);
    ...
    {
        MDIncrementalRefreshTradeSummaryLongQty65 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MDIncrementalRefreshTradeSummaryLongQty65 &_writer)
{
