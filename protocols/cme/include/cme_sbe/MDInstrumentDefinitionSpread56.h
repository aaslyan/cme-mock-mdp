...
#ifndef _CME_SBE_MDINSTRUMENTDEFINITIONSPREAD56_CXX_H_
#define _CME_SBE_MDINSTRUMENTDEFINITIONSPREAD56_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(255);
    ...
    {
        MDInstrumentDefinitionSpread56 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
public:
    ...
    MDInstrumentDefinitionSpread56 &putSecurityExchange(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putSecurityExchange(T&& src)  SBE_NOEXCEPT requires
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecurityExchange(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecurityGroup(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putSecurityGroup(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecurityGroup(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putAsset(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putAsset(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putAsset(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSymbol(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putSymbol(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSymbol(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecurityType(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putSecurityType(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecurityType(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putCFICode(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putCFICode(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putCFICode(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putCurrency(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 3, "array too large for putCurrency");

        std::memcpy(m_buffer + m_offset + 76, src.data(), sizeof(char) * N);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putCurrency(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putCurrency(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    SBE_NODISCARD std::span<const char> getSecuritySubTypeAsSpan() const SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecuritySubType(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 5, "array too large for putSecuritySubType");

        std::memcpy(m_buffer + m_offset + 79, src.data(), sizeof(char) * N);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putSecuritySubType(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putSecuritySubType(const char (&src)[N]) SBE_NOEXCEPT
    {
        return putSecuritySubType(std::span<const char, N>(src));
    }
    #endif
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putUnitOfMeasure(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 30, "array too large for putUnitOfMeasure");

        std::memcpy(m_buffer + m_offset + 120, src.data(), sizeof(char) * N);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putUnitOfMeasure(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putUnitOfMeasure(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putPriceQuoteMethod(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 5, "array too large for putPriceQuoteMethod");

        std::memcpy(m_buffer + m_offset + 195, src.data(), sizeof(char) * N);
        for (std::size_t start = N; start < 5; ++start)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putPriceQuoteMethod(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putPriceQuoteMethod(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putRiskSet(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 6, "array too large for putRiskSet");

        std::memcpy(m_buffer + m_offset + 200, src.data(), sizeof(char) * N);
        for (std::size_t start = N; start < 6; ++start)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putRiskSet(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putRiskSet(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putMarketSet(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 6, "array too large for putMarketSet");

        std::memcpy(m_buffer + m_offset + 206, src.data(), sizeof(char) * N);
        for (std::size_t start = N; start < 6; ++start)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putMarketSet(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putMarketSet(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putFinancialInstrumentFullName(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 35, "array too large for putFinancialInstrumentFullName");

        std::memcpy(m_buffer + m_offset + 220, src.data(), sizeof(char) * N);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionSpread56 &putFinancialInstrumentFullName(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionSpread56 &putFinancialInstrumentFullName(const char (&src)[N]) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MDInstrumentDefinitionSpread56 &_writer)
{
