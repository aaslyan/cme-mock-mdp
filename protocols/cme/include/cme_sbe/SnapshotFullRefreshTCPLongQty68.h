...
#ifndef _CME_SBE_SNAPSHOTFULLREFRESHTCPLONGQTY68_CXX_H_
#define _CME_SBE_SNAPSHOTFULLREFRESHTCPLONGQTY68_CXX_H_
...
public:
    ...
    {
        SnapshotFullRefreshTCPLongQty68 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
