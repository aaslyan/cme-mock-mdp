...
#ifndef _CME_SBE_MDINSTRUMENTDEFINITIONOPTION55_CXX_H_
#define _CME_SBE_MDINSTRUMENTDEFINITIONOPTION55_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(221);
    ...
    {
        MDInstrumentDefinitionOption55 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
public:
    ...
    MDInstrumentDefinitionOption55 &putSecurityExchange(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putSecurityExchange(T&& src)  SBE_NOEXCEPT requires
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSecurityExchange(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSecurityGroup(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putSecurityGroup(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSecurityGroup(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putAsset(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putAsset(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putAsset(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSymbol(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putSymbol(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSymbol(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSecurityType(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putSecurityType(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSecurityType(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putCFICode(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putCFICode(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putCFICode(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putCurrency(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putCurrency(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putCurrency(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putStrikeCurrency(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 3, "array too large for putStrikeCurrency");

        std::memcpy(m_buffer + m_offset + 88, src.data(), sizeof(char) * N);
        for (std::size_t start = N; start < 3; ++start)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putStrikeCurrency(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putStrikeCurrency(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSettlCurrency(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 3, "array too large for putSettlCurrency");

        std::memcpy(m_buffer + m_offset + 91, src.data(), sizeof(char) * N);
        for (std::size_t start = N; start < 3; ++start)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putSettlCurrency(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putSettlCurrency(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putUnitOfMeasure(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 30, "array too large for putUnitOfMeasure");

        std::memcpy(m_buffer + m_offset + 139, src.data(), sizeof(char) * N);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionOption55 &putUnitOfMeasure(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionOption55 &putUnitOfMeasure(const char (&src)[N]) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MDInstrumentDefinitionOption55 &_writer)
{
