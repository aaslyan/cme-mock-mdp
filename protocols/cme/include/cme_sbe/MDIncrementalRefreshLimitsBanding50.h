...
#ifndef _CME_SBE_MDINCREMENTALREFRESHLIMITSBANDING50_CXX_H_
#define _CME_SBE_MDINCREMENTALREFRESHLIMITSBANDING50_CXX_H_
...
public:
    ...
    {
        MDIncrementalRefreshLimitsBanding50 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MDIncrementalRefreshLimitsBanding50 &_writer)
{
