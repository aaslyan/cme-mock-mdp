...
#ifndef _CME_SBE_MDINCREMENTALREFRESHBOOK46_CXX_H_
#define _CME_SBE_MDINCREMENTALREFRESHBOOK46_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(46);
    ...
    {
        MDIncrementalRefreshBook46 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
