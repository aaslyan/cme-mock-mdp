...
#ifndef _CME_SBE_ADMINHEARTBEAT12_CXX_H_
#define _CME_SBE_ADMINHEARTBEAT12_CXX_H_
...
public:
    ...
    {
        AdminHeartbeat12 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const AdminHeartbeat12 &_writer)
{
