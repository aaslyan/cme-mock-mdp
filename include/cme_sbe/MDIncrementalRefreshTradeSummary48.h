...
#ifndef _CME_SBE_MDINCREMENTALREFRESHTRADESUMMARY48_CXX_H_
#define _CME_SBE_MDINCREMENTALREFRESHTRADESUMMARY48_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(48);
    ...
    {
        MDIncrementalRefreshTradeSummary48 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MDIncrementalRefreshTradeSummary48 &_writer)
{
