...
#ifndef _CME_SBE_ADMINLOGIN15_CXX_H_
#define _CME_SBE_ADMINLOGIN15_CXX_H_
...
public:
    ...
    {
        AdminLogin15 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const AdminLogin15 &_writer)
{
    AdminLogin15 writer(
        _writer.m_buffer,
        _writer.m_offset,
