...
#ifndef _CME_SBE_MDINSTRUMENTDEFINITIONFUTURE54_CXX_H_
#define _CME_SBE_MDINSTRUMENTDEFINITIONFUTURE54_CXX_H_
...
public:
    ...
    {
        MDInstrumentDefinitionFuture54 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
public:
    ...
    MDInstrumentDefinitionFuture54 &putSecurityExchange(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putSecurityExchange(T&& src)  SBE_NOEXCEPT requires
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSecurityExchange(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSecurityGroup(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putSecurityGroup(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSecurityGroup(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putAsset(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putAsset(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putAsset(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSymbol(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putSymbol(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSymbol(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSecurityType(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putSecurityType(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSecurityType(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putCFICode(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putCFICode(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putCFICode(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putCurrency(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putCurrency(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putCurrency(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSettlCurrency(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putSettlCurrency(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putSettlCurrency(const char (&src)[N]) SBE_NOEXCEPT
    {
...
public:
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putUnitOfMeasure(std::span<const char, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 30, "array too large for putUnitOfMeasure");

        std::memcpy(m_buffer + m_offset + 110, src.data(), sizeof(char) * N);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    MDInstrumentDefinitionFuture54 &putUnitOfMeasure(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    MDInstrumentDefinitionFuture54 &putUnitOfMeasure(const char (&src)[N]) SBE_NOEXCEPT
    {
