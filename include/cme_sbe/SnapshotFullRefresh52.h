...
#ifndef _CME_SBE_SNAPSHOTFULLREFRESH52_CXX_H_
#define _CME_SBE_SNAPSHOTFULLREFRESH52_CXX_H_
...
public:
    ...
    {
        SnapshotFullRefresh52 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const SnapshotFullRefresh52 &_writer)
{
