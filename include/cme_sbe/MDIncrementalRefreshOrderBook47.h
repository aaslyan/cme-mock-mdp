...
#ifndef _CME_SBE_MDINCREMENTALREFRESHORDERBOOK47_CXX_H_
#define _CME_SBE_MDINCREMENTALREFRESHORDERBOOK47_CXX_H_
...
public:
    ...
    {
        MDIncrementalRefreshOrderBook47 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
