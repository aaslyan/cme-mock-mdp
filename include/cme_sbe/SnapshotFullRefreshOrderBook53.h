...
#ifndef _CME_SBE_SNAPSHOTFULLREFRESHORDERBOOK53_CXX_H_
#define _CME_SBE_SNAPSHOTFULLREFRESHORDERBOOK53_CXX_H_
...
public:
    ...
    {
        SnapshotFullRefreshOrderBook53 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
